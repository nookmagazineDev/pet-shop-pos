...
export default function TaxInvoiceModal({ isOpen, onClose, cart, paymentMethod, subtotal, tax, total, receiptType, customerInfo, taxInvoiceNo }) {
  ...
  const discountAmount = subtotal - total; // total = subtotalAfterDiscount แล้ว
  ...
  const handlePrint = async () => {
    ...
    win.document.write(`<!DOCTYPE html><html><head>
      ...
      <div class="flex-between">
        ...
        <span>${(total - tax).toLocaleString("th-TH", { minimumFractionDigits: 2 })}</span>
      </div>
        ...
        <div className="flex-1 overflow-auto p-8 print:p-0">
          ...
          <div className="flex flex-col items-end space-y-2 mb-8">
            <div className="w-64 flex justify-between text-sm text-gray-500">
              ...
              <span>{(total - tax).toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
            </div>
            <div className="w-64 flex justify-between text-sm text-gray-500">
